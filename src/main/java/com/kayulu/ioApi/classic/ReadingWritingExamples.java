...
//        copyBinaryFile(true);
    ...
    public static void copyTextFile(boolean buffering){
        File src = new File ("src/main/java/com/kayulu/ioApi/InputStreamReaderExample.java");
        File dest = new File ("src/main/java/com/kayulu/ioApi/InputStreamReaderExample2.java");
    ...
    public static void copyBinaryFile(boolean buffering){
        ...
        File src = new File ("./target/classes/com/kayulu/ioApi/ReadingWritingExamples.class");
        File dest = new File ("./target/classes/com/kayulu/ioApi/ReadingWritingExamples2.class");
