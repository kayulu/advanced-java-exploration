package com.kayulu.collections.basics;
...
class Boss implements Comparable<Boss>{
    ...
    public int compareTo(Boss otherBoss){   // define natural order for Boss
...
//        System.out.println(bosses); // [Boss{id=10}, Boss{id=15}, Boss{id=20}]
        ...
        // Worker has no natural order defined, therefor it needs a Comparator to be used by the TreeSet<Worker>
